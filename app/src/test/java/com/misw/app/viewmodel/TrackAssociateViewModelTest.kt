...
class TrackAssociateViewModelTest {
    ...
    fun setUp() {
        ...
        // Create viewmodel instance (we'll need to inject the repository)
        // Since the viewModel creates its own repository, we'll test the validation logic
    }

    @Test
    fun testValidateEmptyTrackName() = runTest {
    ...
    @Test
    fun testValidateEmptyMinutes() = runTest {
        viewModel = TrackAssociateViewModel(mockApplication)
        viewModel.associationSuccess.observeForever(successObserver)
        viewModel.error.observeForever(errorObserver)
    ...
    @Test
    fun testValidateEmptySeconds() = runTest {
        viewModel = TrackAssociateViewModel(mockApplication)
        viewModel.associationSuccess.observeForever(successObserver)
        viewModel.error.observeForever(errorObserver)
    ...
    @Test
    fun testValidateInvalidMinutes() = runTest {
        viewModel = TrackAssociateViewModel(mockApplication)
        viewModel.associationSuccess.observeForever(successObserver)
        viewModel.error.observeForever(errorObserver)
    ...
    @Test
    fun testValidateInvalidSeconds() = runTest {
        viewModel = TrackAssociateViewModel(mockApplication)
        viewModel.associationSuccess.observeForever(successObserver)
        viewModel.error.observeForever(errorObserver)
    ...
    @Test
    fun testValidateSecondsTooLarge() = runTest {
        viewModel = TrackAssociateViewModel(mockApplication)
        viewModel.associationSuccess.observeForever(successObserver)
        viewModel.error.observeForever(errorObserver)
    ...
    @Test
    fun testValidateSecondsEquals59() = runTest {
        viewModel = TrackAssociateViewModel(mockApplication)
        viewModel.error.observeForever(errorObserver)
    ...
    @Test
    fun testValidateSecondsEquals0() = runTest {
        viewModel = TrackAssociateViewModel(mockApplication)
        viewModel.error.observeForever(errorObserver)
    ...
    @Test
    fun testLoadingStateChanges() = runTest {
        viewModel = TrackAssociateViewModel(mockApplication)
    ...
    @Test
    fun testDurationFormattingWithPaddedZeros() = runTest {
        viewModel = TrackAssociateViewModel(mockApplication)
        viewModel.error.observeForever(errorObserver)
    ...
    @Test
    fun testAllFieldsRequired() = runTest {
        viewModel = TrackAssociateViewModel(mockApplication)
        viewModel.error.observeForever(errorObserver)
    ...
    @Test
    fun testSecondsBoundaryConditions() = runTest {
        viewModel = TrackAssociateViewModel(mockApplication)
        viewModel.error.observeForever(errorObserver)
    ...
    @Test
    fun testMinutesCanBeAnyValidNumber() = runTest {
        viewModel = TrackAssociateViewModel(mockApplication)
        viewModel.error.observeForever(errorObserver)
    ...
    @Test
    fun testWhitespaceOnlyTrackName() = runTest {
        viewModel = TrackAssociateViewModel(mockApplication)
        viewModel.error.observeForever(errorObserver)
