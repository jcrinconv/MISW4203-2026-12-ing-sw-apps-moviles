...
class TrackAssociateViewModelIntegrationTest {
    ...
    @Test
    fun testSuccessfulTrackAssociation() = runTest {
    ...
    @Test
    fun testRepositoryCalledWithCorrectData() = runTest {
        val mockTrack = Track(
            id = 1,
            name = "Track Name",
            duration = "05:30",
    ...
    @Test
    fun testErrorHandlingOnRepositoryException() = runTest {
    ...
    @Test
    fun testLoadingStateOnSuccess() = runTest {
        val mockTrack = Track(
            id = 1,
            name = "Track",
            duration = "03:00",
    ...
    @Test
    fun testErrorClearedOnNewAttempt() = runTest {
    ...
    @Test
    fun testDurationFormattingPaddingZeros() = runTest {
        val mockTrack = Track(
            id = 1,
            name = "Track",
            duration = "05:09",
