...
class AlbumDetailViewModelTest {
    ...
    @Test
    fun testLoadAlbumSuccess() = runTest {
        val testAlbum = Album(
            id = 1,
            name = "Test Album",
    ...
    @Test
    fun testRefreshAlbumAfterAddingTrack() = runTest {
    ...
    @Test
    fun testLoadingStateOnLoad() = runTest {
        val testAlbum = Album(
            id = 1,
            name = "Album",
            cover = "http://example.com/cover.jpg",
    ...
    @Test
    fun testRefreshWithoutPriorLoad() = runTest {
        viewModel = AlbumDetailViewModel(mockApplication)
    ...
    @Test
    fun testLoadAlbumWithTracks() = runTest {
        val album = Album(
            id = 1,
            name = "Album",
            cover = "http://example.com/cover.jpg",
    ...
    @Test
    fun testMultipleReloadsOfSameAlbum() = runTest {
        val album = Album(
            id = 1,
            name = "Album",
            cover = "http://example.com/cover.jpg",
